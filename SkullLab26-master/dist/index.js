...
import React__default, { useState, useEffect, useContext, createContext, forwardRef, isValidElement, cloneElement, Children, useRef } from 'react';
...
const SelectionContext = /*#__PURE__*/createContext(0);
function SelectionContextProvider(_ref) {
  ...
  const traverseChildren = function (children) {
    let parentID = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
    if (!children) return [];
    let childItems = [];
    for (const child of children) {
      childItems.push(_objectSpread2(_objectSpread2({}, child), {}, {
        parentID: parentID
      }));
  ...
  const traverseJSON = sections => {
    ...
    for (const section of sections) {
      var _section$data;
      if (((_section$data = section.data) === null || _section$data === void 0 ? void 0 : _section$data.length) > 0) {
  ...
  useEffect(() => {
    ...
    if (data !== null && data !== void 0 && data.sections) {
      // ← check for sections
...
function useRefWithInit(init, initArg) {
  const ref = React$1.useRef(UNINITIALIZED$1);
...
var reactMajor = parseInt(React$1.version, 10);
...
function useStoreR19(store, selector, a1, a2, a3) {
  const getSelection = React$1.useCallback(() => selector(store.getSnapshot(), a1, a2, a3), [store, selector, a1, a2, a3]);
...
function deepClone(source) {
  if (/*#__PURE__*/React$1.isValidElement(source) || reactIsExports$1.isValidElementType(source) || !isPlainObject(source)) {
    return source;
  }
  const output = {};
...
function deepmerge(target, source, options = {
  ...
  if (isPlainObject(target) && isPlainObject(source)) {
    Object.keys(source).forEach(key => {
      if (/*#__PURE__*/React$1.isValidElement(source[key]) || reactIsExports$1.isValidElementType(source[key])) {
...
function useForkRef(...refs) {
  const cleanupRef = React$1.useRef(undefined);
...
const CircularProgress = /*#__PURE__*/React$1.forwardRef(function CircularProgress(inProps, ref) {
  ...
  return /*#__PURE__*/jsx$1(CircularProgressRoot, {
    ...
    children: /*#__PURE__*/jsxs(CircularProgressSVG, {
      ...
      children: [enableTrackSlot ? /*#__PURE__*/jsx$1(CircularProgressTrack, {
        ...
        "aria-hidden": "true"
      }) : null, /*#__PURE__*/jsx$1(CircularProgressCircle, {
...
var SuccessOutlinedIcon = createSvgIcon(/*#__PURE__*/jsx$1("path", {
  d: "M20,12A8,8 0 0,1 12,20A8,8 0 0,1 4,12A8,8 0 0,1 12,4C12.76,4 13.5,4.11 14.2, 4.31L15.77,2.74C14.61,2.26 13.34,2 12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0, 0 22,12M7.91,10.08L6.5,11.5L11,16L21,6L19.59,4.58L11,13.17L7.91,10.08Z"
}), 'SuccessOutlined');

var ReportProblemOutlinedIcon = createSvgIcon(/*#__PURE__*/jsx$1("path", {
  d: "M12 5.99L19.53 19H4.47L12 5.99M12 2L1 21h22L12 2zm1 14h-2v2h2v-2zm0-6h-2v4h2v-4z"
}), 'ReportProblemOutlined');

var ErrorOutlineIcon = createSvgIcon(/*#__PURE__*/jsx$1("path", {
  d: "M11 15h2v2h-2zm0-8h2v6h-2zm.99-5C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2zM12 20c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8z"
}), 'ErrorOutline');

var InfoOutlinedIcon = createSvgIcon(/*#__PURE__*/jsx$1("path", {
  d: "M11,9H13V7H11M12,20C7.59,20 4,16.41 4,12C4,7.59 7.59,4 12,4C16.41,4 20,7.59 20, 12C20,16.41 16.41,20 12,20M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10, 10 0 0,0 12,2M11,17H13V11H11V17Z"
}), 'InfoOutlined');

var CloseIcon = createSvgIcon(/*#__PURE__*/jsx$1("path", {
...
const defaultIconMapping = {
  success: /*#__PURE__*/jsx$1(SuccessOutlinedIcon, {
    fontSize: "inherit"
  }),
  warning: /*#__PURE__*/jsx$1(ReportProblemOutlinedIcon, {
    fontSize: "inherit"
  }),
  error: /*#__PURE__*/jsx$1(ErrorOutlineIcon, {
    fontSize: "inherit"
  }),
  info: /*#__PURE__*/jsx$1(InfoOutlinedIcon, {
    fontSize: "inherit"
  })
};
const Alert = /*#__PURE__*/React$1.forwardRef(function Alert(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: 'MuiAlert'
  });
  ...
  return /*#__PURE__*/jsxs(RootSlot, {
    ...rootSlotProps,
    children: [icon !== false ? /*#__PURE__*/jsx$1(IconSlot, {
      ...iconSlotProps,
      children: icon || iconMapping[severity]
    }) : null, /*#__PURE__*/jsx$1(MessageSlot, {
      ...messageSlotProps,
      children: children
    }), action != null ? /*#__PURE__*/jsx$1(ActionSlot, {
      ...actionSlotProps,
      children: action
    }) : null, action == null && onClose ? /*#__PURE__*/jsx$1(ActionSlot, {
      ...actionSlotProps,
      children: /*#__PURE__*/jsx$1(CloseButtonSlot, {
        size: "small",
        ...
        onClick: onClose,
        ...closeButtonProps,
        children: /*#__PURE__*/jsx$1(CloseIconSlot, {
          fontSize: "small",
          ...closeIconProps
        })
      })
 ...
 * @ignore - internal component.
 */
const TreeViewContext = /*#__PURE__*/React$1.createContext(null);
if (process.env.NODE_ENV !== "production") TreeViewContext.displayName = "TreeViewContext";
const useTreeViewContext = () => {
  const context = React$1.useContext(TreeViewContext);
  if (context == null) {
 ...
 * @ignore - internal component.
 */
const TreeViewStyleContext = /*#__PURE__*/React$1.createContext({
  classes: {},
  slots: {},
  slotProps: {}
});
...
const useTreeViewBuildContext = parameters => {
  ...
  const runItemPlugins = React$1.useCallback(itemPluginProps => {
  ...
  const wrapItem = React$1.useCallback(({
    itemId,
    children,
    idAttribute
  }) => {
...
function TreeViewProvider(props) {
  ...
  const styleContextValue = React$1.useMemo(() => ({
    classes,
    slots: {
  ...
  return /*#__PURE__*/jsx$1(TreeViewContext.Provider, {
    value: contextValue,
    children: /*#__PURE__*/jsx$1(TreeViewStyleContext.Provider, {
  ...
  return /*#__PURE__*/jsx$1(TransitionComponent, {
    ...
    children: (state, {
      ...
      return /*#__PURE__*/jsx$1(RootSlot, {
        ...
        ...restChildProps,
        children: /*#__PURE__*/jsx$1(WrapperSlot, {
          ...wrapperSlotProps,
          ownerState: stateOwnerState,
          children: /*#__PURE__*/jsx$1(WrapperInnerSlot, {
 ...
 * @ignore - internal component.
 */
const SwitchBase = /*#__PURE__*/React$1.forwardRef(function SwitchBase(props, ref) {
  const {
    autoFocus,
    checked: checkedProp,
    checkedIcon,
...
var CheckBoxOutlineBlankIcon = createSvgIcon(/*#__PURE__*/jsx$1("path", {
  d: "M19 5v14H5V5h14m0-2H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2z"
}), 'CheckBoxOutlineBlank');

var CheckBoxIcon = createSvgIcon(/*#__PURE__*/jsx$1("path", {
  d: "M19 3H5c-1.11 0-2 .9-2 2v14c0 1.1.89 2 2 2h14c1.11 0 2-.9 2-2V5c0-1.1-.89-2-2-2zm-9 14l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z"
}), 'CheckBox');

var IndeterminateCheckBoxIcon = createSvgIcon(/*#__PURE__*/jsx$1("path", {
...
const Checkbox = /*#__PURE__*/React$1.forwardRef(function Checkbox(inProps, ref) {
  ...
  const [RootSlot, rootSlotProps] = useSlot('root', {
    ...
    additionalProps: {
      ...
      checkedIcon: /*#__PURE__*/React$1.cloneElement(indeterminateIcon, {
...
const TreeViewItemDepthContext = /*#__PURE__*/React$1.createContext(() => -1);
...
const useTreeItem = parameters => {
  ...
  const depthContext = React$1.useContext(TreeViewItemDepthContext);
  ...
  const rootRefObject = React$1.useRef(null);
  const contentRefObject = React$1.useRef(null);
  ...
  const checkboxRef = React$1.useRef(null);
  const isCheckboxSelectionEnabled = useStore(store, selectionSelectors.isCheckboxSelectionEnabled);
...
const TreeViewExpandIcon = createSvgIcon(/*#__PURE__*/jsx$1("path", {
  d: "M10 6 8.59 7.41 13.17 12l-4.58 4.59L10 18l6-6z"
}), 'TreeViewExpandIcon');
const TreeViewCollapseIcon = createSvgIcon(/*#__PURE__*/jsx$1("path", {
...
function TreeItemIcon(props) {
  ...
  return /*#__PURE__*/jsx$1(Icon, _extends$1({}, iconProps));
}
...
function TreeItemDragAndDropOverlay(props) {
  ...
  return /*#__PURE__*/jsx$1(TreeItemDragAndDropOverlayRoot, _extends$1({}, props));
}
...
function TreeItemProvider(props) {
  ...
  const idAttribute = useStore(store, idSelectors.treeItemIdAttribute, itemId, id);
  return /*#__PURE__*/jsx$1(React$1.Fragment, {
    children: wrapItem({
      children,
      itemId,
      store,
...
const TreeItemCheckbox = styled(/*#__PURE__*/React$1.forwardRef((props, ref) => {
  const {
      visible
    } = props,
  ...
  return /*#__PURE__*/jsx$1(Checkbox, _extends$1({}, other, {
    ref: ref
  }));
}), {
  name: 'MuiTreeItem',
 ...
 */
const TreeItem = /*#__PURE__*/React$1.forwardRef(function TreeItem(inProps, forwardedRef) {
  ...
  return /*#__PURE__*/jsx$1(TreeItemProvider, _extends$1({}, getContextProviderProps(), {
    children: /*#__PURE__*/jsxs(Root, _extends$1({}, rootProps, {
      children: [/*#__PURE__*/jsxs(Content, _extends$1({}, contentProps, {
        children: [/*#__PURE__*/jsxs(IconContainer, _extends$1({}, iconContainerProps, {
          children: [status.error && /*#__PURE__*/jsx$1(ErrorIcon, _extends$1({}, errorContainerProps)), status.loading ? /*#__PURE__*/jsx$1(LoadingIcon, _extends$1({}, loadingContainerProps)) : /*#__PURE__*/jsx$1(TreeItemIcon, {
            status: status,
            slots: slots,
            slotProps: slotProps
          })]
        })), /*#__PURE__*/jsx$1(Checkbox, _extends$1({}, checkboxProps)), status.editing ? /*#__PURE__*/jsx$1(LabelInput, _extends$1({}, labelInputProps)) : /*#__PURE__*/jsx$1(Label, _extends$1({}, labelProps)), /*#__PURE__*/jsx$1(DragAndDropOverlay, _extends$1({}, dragAndDropOverlayProps))]
      })), children && /*#__PURE__*/jsx$1(TreeItemGroupTransition, _extends$1({
        as: GroupTransition
...
const RichTreeViewItemsContext = /*#__PURE__*/React$1.createContext(null);
...
const WrappedTreeItem = /*#__PURE__*/React$1.memo(function WrappedTreeItem({
  itemSlot,
  itemSlotProps,
  itemId,
  skipChildren
}) {
  const renderItemForRichTreeView = React$1.useContext(RichTreeViewItemsContext);
  const {
    store
  } = useTreeViewContext();
  ...
  return /*#__PURE__*/jsx$1(Item, _extends$1({}, itemProps, {
...
function RichTreeViewItems(props) {
  ...
  const renderItem = React$1.useCallback(itemId => {
    return /*#__PURE__*/jsx$1(WrappedTreeItem, {
      itemSlot: itemSlot,
  ...
  return /*#__PURE__*/jsx$1(RichTreeViewItemsContext.Provider, {
    value: renderItem,
...
function useExtractRichTreeViewParameters(props) {
  ...
  const parameters = React$1.useMemo(() => ({
    // Shared parameters
    disabledItemsFocusable,
    items,
    isItemDisabled,
...
const useLabelEditingItemPlugin = ({
  ...
  const [labelInputValue, setLabelInputValue] = React$1.useState(label);
 ...
 */
const RichTreeView = /*#__PURE__*/React$1.forwardRef(function RichTreeView(inProps, forwardedRef) {
  ...
  if (error) {
    return /*#__PURE__*/jsx$1(Alert, {
      severity: "error",
      children: error.message
    });
  }
  return /*#__PURE__*/jsx$1(TreeViewProvider, {
    store: store,
    classes: classes,
    slots: slots,
    slotProps: slotProps,
    apiRef: apiRef,
    rootRef: ref,
    children: /*#__PURE__*/jsx$1(TreeViewItemDepthContext.Provider, {
      value: itemsSelectors.itemDepth,
      children: /*#__PURE__*/jsx$1(Root, _extends$1({}, rootProps, {
        children: /*#__PURE__*/jsx$1(RichTreeViewItems, {
          slots: slots,
          slotProps: slotProps
        })
      }))
...
const SectionTreeItem = /*#__PURE__*/React$1.forwardRef(function SectionTreeItem(itemProps, ref) {
  var _item$type, _item$children, _item$child_items;
  const isHeader = itemProps.itemId === "0" || itemProps.itemId === "101";
  const item = useTreeItemModel(itemProps.itemId);
  const itemType = String((_item$type = item === null || item === void 0 ? void 0 : item.type) !== null && _item$type !== void 0 ? _item$type : '').toLowerCase();
  const isNone = itemType === 'none';
  const hasChildren = (item === null || item === void 0 || (_item$children = item.children) === null || _item$children === void 0 ? void 0 : _item$children.length) > 0;
  const pageLink = item === null || item === void 0 || (_item$child_items = item.child_items) === null || _item$child_items === void 0 || (_item$child_items = _item$child_items[0]) === null || _item$child_items === void 0 ? void 0 : _item$child_items.page;
  const hasExternalPage = typeof pageLink === 'string' && pageLink.trim() !== '' && pageLink !== 'LINK HERE';
  return /*#__PURE__*/React$1.createElement(TreeItem, _extends$2({
    className: "item"
  }, itemProps, {
    ref: ref,
    sx: _objectSpread2(_objectSpread2(_objectSpread2(_objectSpread2(_objectSpread2({
      width: "100%",
      color: 'white',
...
function SectionTreeView(_ref) {
  ...
  const convertIdsToStrings = items => {
    return items.map(item => _objectSpread2(_objectSpread2({}, item), {}, {
      id: String(item.id),
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: "container"
  }, /*#__PURE__*/React.createElement(RichTreeView, {
    items: stringIdData,
    selectedItems: selectedItem !== null && selectedItem !== void 0 && selectedItem.id ? String(selectedItem.id) : '',
    onItemClick: (event, itemId) => {
      var _item$type, _item$child_items;
    ...
    slots: {
      expandIcon: () => /*#__PURE__*/React.createElement("div", null, " + "),
      collapseIcon: () => /*#__PURE__*/React.createElement("div", null, " - "),
...
function MobileMenu(_ref) {
  ...
  const menu = /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement("button", {
  ...
  }, /*#__PURE__*/React__default.createElement(HiMenu, {
    size: 20,
    color: "black"
    ...
    className: "flex flex-col gap-2 px-4 py-3 border-b border-white/20 sticky top-0 bg-[#1a5e80] z-10"
  }, /*#__PURE__*/React__default.createElement("a", {
    href: "",
    className: "block w-full text-center px-4 py-2 bg-white hover:bg-gray-100 text-[#1a5e80] font-semibold rounded-lg shadow text-sm"
  }, "Main Menu"), /*#__PURE__*/React__default.createElement("div", {
    className: "flex items-center justify-between"
  }, /*#__PURE__*/React__default.createElement("span", {
    className: "text-white font-semibold text-base"
  }, "Menu"), /*#__PURE__*/React__default.createElement("button", {
    onClick: () => setOpen(false),
    ...
    className: "w-full"
  }, sections.map(section => /*#__PURE__*/React__default.createElement(SectionTreeView, {
    key: section.id,
    className: "tree",
    section: section.title,
    data: section.data
  })))));
  return /*#__PURE__*/createPortal(menu, document.body);
}
function DesktopMenu(_ref2) {
  ...
  return /*#__PURE__*/React__default.createElement("aside", {
    className: "flex flex-col h-full w-72 bg-[#1a5e80] shadow-md overflow-auto"
  }, /*#__PURE__*/React__default.createElement("div", {
    className: "px-4 py-3 border-b border-white/20"
  }, /*#__PURE__*/React__default.createElement("a", {
    href: "",
    className: "block w-full text-center px-4 py-2 bg-white hover:bg-gray-100 text-[#1a5e80] font-semibold rounded-lg shadow text-sm"
  }, "Main Menu")), /*#__PURE__*/React__default.createElement("nav", {
...
function SectionMenu(_ref3) {
  ...
  return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, isMobile ? /*#__PURE__*/React__default.createElement(MobileMenu, {
    sections: sections
  }) : /*#__PURE__*/React__default.createElement(DesktopMenu, {
    sections: sections
  }));
}
...
function SectionMenuImprove(_ref) {
  ...
  const menu = /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("button", {
    onClick: () => {
...
function VideoPlayer() {
  ...
  useEffect(() => {
    var _selectedItem$child_i;
    const newSource = selectedItem === null || selectedItem === void 0 || (_selectedItem$child_i = selectedItem.child_items) === null || _selectedItem$child_i === void 0 || (_selectedItem$child_i = _selectedItem$child_i[0]) === null || _selectedItem$child_i === void 0 ? void 0 : _selectedItem$child_i.video_link;
    setSource(newSource);
  }, [selectedItem]);
  return /*#__PURE__*/React.createElement("div", {
    className: "flex justify-center items-center fit-content bg-black h-screen pb-24"
...
function ImgWindow() {
  ...
  useEffect(() => {
    ...
    const firstImg = selectedItem === null || selectedItem === void 0 || (_selectedItem$buttons = selectedItem.buttons) === null || _selectedItem$buttons === void 0 || (_selectedItem$buttons = _selectedItem$buttons[0]) === null || _selectedItem$buttons === void 0 ? void 0 : _selectedItem$buttons.img;
    setImg(typeof firstImg === 'string' ? firstImg : null);
  }, [selectedItem]);

  // Functions
  function playSound() {
    const sound = selectedItem === null || selectedItem === void 0 ? void 0 : selectedItem.sound;
    if (!sound) return;
  ...
  // vars and helpers
  const buttons = (selectedItem === null || selectedItem === void 0 ? void 0 : selectedItem.buttons) || [];

  // JSX
  return /*#__PURE__*/React.createElement("div", {
    className: "w-full h-screen overflow-hidden flex items-center flex-col bg-black"
  }, /*#__PURE__*/React.createElement("div", {
    className: "flex flex-wrap gap-2 px-6 pt-4 pb-2 w-full justify-center"
  }, buttons.map((button, index) => {
    return button.label ? /*#__PURE__*/React.createElement("button", {
      className: "bg-gray-600 hover:bg-gray-300 px-3 py-1 min-h-7 w-auto max-w-full text-white text-sm leading-tight whitespace-normal break-words rounded",
      key: index,
      onClick: () => button.img ? setImg(button.img) : null
    }, button.label) : null;
  }), /*#__PURE__*/React.createElement("button", {
    onClick: () => playSound(),
    ...
    className: "w-full max-w-5xl h-[65vh] px-4 flex items-center justify-center overflow-hidden"
...
function Lecture() {
  ...
  useEffect(() => {
    var _selectedItem$child_i;
    const newSource = (selectedItem === null || selectedItem === void 0 ? void 0 : selectedItem.load) || (selectedItem === null || selectedItem === void 0 || (_selectedItem$child_i = selectedItem.child_items) === null || _selectedItem$child_i === void 0 || (_selectedItem$child_i = _selectedItem$child_i[0]) === null || _selectedItem$child_i === void 0 ? void 0 : _selectedItem$child_i.load);
    setSource(newSource);
  }, [selectedItem]);
  return /*#__PURE__*/React.createElement("div", {
...
function ContentWindow() {
  ...
  const clickHandlerPrev = () => {
    ...
    while (prevIndex >= 0 && ((_allItems$prevIndex = allItems[prevIndex]) === null || _allItems$prevIndex === void 0 ? void 0 : _allItems$prevIndex.type) === "none") {
      var _allItems$prevIndex;
      prevIndex--;
    }
    if (prevIndex <= 0) {
      showToast('No previous item');
  ...
  const clickHandlerNext = () => {
    const curItemIndex = allItems.findIndex(item => item.id === selectedItem.id);
    if (curItemIndex === -1) {
      // ← only block if item not found
      return;
    }

    // Walk forwards to find the nearest non-"none" item
    let nextIndex = curItemIndex + 1;
    while (nextIndex < allItems.length && ((_allItems$nextIndex = allItems[nextIndex]) === null || _allItems$nextIndex === void 0 ? void 0 : _allItems$nextIndex.type) === "none") {
      var _allItems$nextIndex;
      // ← < not >=
      nextIndex++;
    }
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "absolute top-4 left-1/2 -translate-x-1/2 bg-black text-white px-4 py-2 rounded z-20"
  }, toastMessage), /*#__PURE__*/React.createElement("button", {
    className: "absolute left-0 top-1/2 -translate-y-1/2 z-10 bg-[#1a5e80] text-white p-2 rounded w-6 h-24 m-2",
  ...
  }))), renderContent(), /*#__PURE__*/React.createElement("button", {
    className: "absolute right-0 top-1/2 -translate-y-1/2 z-10 bg-[#1a5e80] text-white p-2 rounded w-6 h-24 m-2",
...
export { ContentWindow, Header, ImgWindow, Lecture, SectionMenu, SectionMenuImprove, SectionTreeItem, SectionTreeView, SelectionContextProvider, VideoPlayer, useSelectionContext };
