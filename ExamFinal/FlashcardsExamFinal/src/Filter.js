/**
 * A filter component that allows users to select cards by ID.
 * Provides options to select all, deselect all, or filter by specific card IDs.
 *
 * @returns {JSX.Element} A filter dropdown with card ID options
 */
...
export default function Filter(){
    ...
    function handleSelectionChange(event) {
        ...
        // This replaces the set, immediately removing cards not in this ID selection.
    };
