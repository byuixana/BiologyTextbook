    ...
    <React.Fragment>
        ...
        >
            ...
            <div className="flex flex-col gap-2 px-4 py-3 border-b border-white/20 sticky top-0 bg-[#1a5e80] z-10">
                <a href="" className="block w-full text-center px-4 py-2 bg-white hover:bg-gray-100 text-[#1a5e80] font-semibold rounded-lg shadow text-sm">Main Menu</a>
...
export default function SectionMenu({ sections }){
    ...
    return (
        <>
            {isMobile ? <MobileMenu sections={sections} /> : <DesktopMenu sections={sections} />}
        </>
    )
}